...
export default class SignUp13 extends Component {
    ...
    handleSelection = choice => {
        this.setState({studyPreferences : choice})
    };
    ...
    handleNext = params => {
        if (!this.state.studyPreferences){
                ...
                <ImageBackground source={require('../assets/images/bg.jpg')} style={{width: '100%', height: '100%'}}>
                    <View style={style.contentContainer}>
                        ...
                        <View style={style.container}>
                            <Title>You {this.state.workout} study.</Title>
                        </View>
                        <View style={style.container}>
                            <Title>When do you prefer to study ?</Title>
                            <View style={style.buttonContainer}>
                                {this.state.studyPreferences == 'mornings' ?
                                ...
                                {this.state.studyPreferences == '6-8 pm' ?   
                            ...
                            <View style={style.buttonContainer}>
                                {this.state.studyPreferences == 'weekends' ?
                                ...
                                {this.state.studyPreferences == 'late night' ?   
